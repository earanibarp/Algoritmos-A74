...
public class Paciente extends Persona {
    ...
    /*calcularIMC(): determinar, si está por debajo de 18.5 su nivel es “Bajo de peso", 
    si está en 18.5 – 24.9 su nivel es "Normal", si está en 25.0 – 29.9 su nivel es "Sobrepeso", 
